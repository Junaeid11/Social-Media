            ...
            <div className="flex items-center">
              ...
              >
               ...
               {/* {logo dibo} */}
                ...
                <span className="font-bold text-lg bg-gradient-to-r from-red-600 to-red-600 bg-clip-text text-transparent group-hover:from-purple-600 group-hover:to-red-600 transition-all duration-500">lal</span>
              </div>
