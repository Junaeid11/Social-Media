        ...
        >
          ...
          <div className="w-full lg:w-5/12 p-8 lg:p-12 bg-white flex flex-col justify-center relative">
            ...
            <p className="mb-8 text-base text-gray-600">
              Log in to your account to connect with friends and explore content
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <motion.button
                  ...
                  className="w-full flex justify-center items-center py-3 px-4 rounded-lg text-base font-medium text-white bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200"
                >
                  {isSubmitting ? (
                    <svg
                ...
                <button
                  ...
                  className="w-full my-4 text-center py-2 px-4 bg-indigo-100 hover:bg-indigo-200 text-indigo-800 rounded-md text-sm font-medium transition duration-200"
                >
          ...
          <div className="w-full lg:w-7/12 relative overflow-hidden bg-red-600">
              ...
              <div className="w-full max-w-md px-8 py-12 text-white">
                ...
                >
                  ...
                  <p className="text-lg opacity-80">
                    Share your moments, discover trending content, engage with
                    your community.
                  </p>
                </motion.div>
