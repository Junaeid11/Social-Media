...
const Page = (props) => {
  ...
  // Handle changing to the previous story manually
...
const users = Object.values(groupedStories);
  ...
  const handleNextUser = () => {
    const currentUserIndex = users.findIndex(
      (userGroup) => userGroup.user._id === storyToShow.user._id
    );
    ...
    <AuthRedirect>
      <div className="bg-gradient-to-br from-indigo-50 to-purple-50 flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen fixed h-full w-screen z-50 inset-0 lg:overflow-hidden overflow-y-auto">
        ...
        >
          <Link
            href="/"
            className="bg-white/80 backdrop-blur-md text-indigo-600 px-4 py-2.5 rounded-full shadow-lg hover:bg-indigo-600 hover:text-white transition-all duration-300 flex items-center text-sm font-medium"
          >
                    ...
                    >
                      <div className="flex items-center cursor-pointer">
                        ...
                        <div className="flex justify-center ml-4 flex-col">
                          ...
                          <p className="text-gray-600 text-sm">
                            {userGroup.stories[0].content.slice(0, 20)}...
                          </p>
                        </div>
                      </div>
                      <div className="flex flex-col items-end">
                        ...
                        <span className="text-xs text-gray-400 mt-1">
                          {userGroup.stories.length} stories
                        </span>
                      </div>
                    </motion.div>
                  </Link>
                ...
                (story, index) => (
                  <motion.div
                    ...
                    style={{
                      width: `${
                        100 /
                        groupedStories[storyToShow.user._id].stories.length
                      }%`,
